...
* 윈도우 인스턴스가 추가됩니다.
    * 이번 점검 이후 ‘Windows 2012 r2 standard ‘ 인스턴스를 생성할 수 있습니다.
* i2 Flavor가 추가됩니다.
    * i2 Flavor는 기존 Flavor들 보다 디스크 IO 성능을 향상시킨 Flavor입니다.
...
* 인스턴스 생성시 사용자가 초기 볼륨의 크기를 지정할 수 있게 됩니다.
    * 기존의 Flavor에 지정된 크기로 초기 볼륨 생성이 아닌 사용자가 지정한 크기 만큼 초기 볼륨을 생성하게 됩니다.
    * 볼륨의 크기는 이미지 최소 요구 사항에서 최대 600GB 까지 설정할 수 있습니다.
        * **※ 새로 추가되는 i2 Flavor는 기존 Flavor와는 달리 크기를 지정할 수 없습니다.**

#### 버그 수정

##### Floating IP

* Floating IP 연결 팝업에서 삭제된 “생성” 버튼이 추가 됩니다.
    * 의도치 않게 삭제된 생성 버튼을 다시 추가하게 됩니다.
