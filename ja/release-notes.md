...
## 2026. 05. 27.
### Instance
* インスタンス一覧照会 API の limit パラメータのデフォルト値(default) 100 件、最大値(max) 1,000 件に調整
* インスタンスの累積停止期間が 90 日を超えているかどうかの情報を提供

### Image
* イメージ一覧照会 API の limit パラメータのデフォルト値(default) 100 件、最大値(max) 1,000 件に調整
...
## 2026. 03. 31.
* 米国(カリフォルニア)リージョンのサービス終了

<a id="march-10-2026"></a>

## 2026. 03. 10.
### Image
* Rocky 9.7 イメージの GRUB BLS 設定を無効化
...
### Instance
* 配置ポリシー機能を追加
* ネットワークインターフェイスの切断時に削除するかどうかを設定する機能を追加
* インスタンスの作成またはブロックストレージの接続時にブロックストレージの削除ポリシーを設定する機能を追加
* コンソールからインスタンスを削除する際の接続済みリソース削除ポリシーを改定
    * ブロックストレージを削除する際に、存在するスナップショットも併せて削除
...
* GPU およびコンテナ関連 (Linux)
    ...
    * MIG Manager: 0.7.0 → 変更なし
    * 最小ディスクサイズ (GB): 20 → 30
    * DCGM-Exporter 未インストール問題のパッチ (NVIDIA、Deep Learning イメージ)
...
## 2024. 04. 23.
### Instance
* インスタンスタイプのサービス終了 - 韓国 (板橋) リージョン該当
...
### Instance
* 暗号化ルートブロックストレージのインスタンスからイメージを作成する機能を追加
* GPU Instance においてインスタンス停止機能を無効化
...
### Public API
* インスタンス終了、終了したインスタンスの起動 API を追加
...
* GPU およびコンテナ関連 (Linux)
    ...
    * NVIDIA ドライバーアップデート: 470.199.02 → 535.104.12
    * CUDA アップデート: 11.4 → 12.2
    * MIG Manager: 0.5.4 → 0.5.5

* GPU (Windows)
	* NVIDIA ドライバーアップデート: 474.44 → 537.13

* セキュリティアップデート (Linux)
	* CentOS 7.9: /usr/bin/newgrp、/sbin/unix_chkpwd SetUID を削除
...
* PIOLINK WEBFRONT-KS 4.0.6.61.28(2023.04.25.)
    * イメージ名変更: PLOS-WAF-KS-v4.0.6.61.28(2023.04.25.) → PIOLINK WEBFRONT-KS 4.0.6.61.28(2023.04.25.)
...
* Windows 2012 R2 STD(2023.08.22.) EN
    * イメージアップデート
    * 23年7月セキュリティアップデート適用: https://support.microsoft.com/en-us/topic/july-11-2023-kb5028228-monthly-rollup-b7ee35a2-91ab-4e36-8e46-7c616d1bd4e4
* Windows 2012 R2 STD(2023.08.22.) KO
    * イメージアップデート
    * 23年7月セキュリティアップデート適用: https://support.microsoft.com/en-us/topic/july-11-2023-kb5028228-monthly-rollup-b7ee35a2-91ab-4e36-8e46-7c616d1bd4e4
* Windows 2012 R2 STD with MS-SQL 2016 Standard(2023.08.22.) EN
...
* Windows 2016 STD(2023.08.22.) EN
    * イメージアップデート
    * 23年7月セキュリティアップデート適用: https://support.microsoft.com/en-au/topic/july-11-2023-kb5028169-os-build-14393-6085-fa5b6c30-1ac8-4b99-b58b-9c434d8a8b98
...
* Windows 2019 STD(2023.08.22.) EN
    * イメージアップデート
    * 23年7月セキュリティアップデート適用: https://support.microsoft.com/en-gb/topic/july-11-2023-kb5028168-os-build-17763-4645-eff2d1e1-5f91-4d9a-aef1-ae26bdf51321
...
* Windows 2022 STD(2023.08.22.) EN
    * イメージアップデート
    * 23年7月セキュリティアップデート適用: https://support.microsoft.com/en-us/topic/july-11-2023-security-update-kb5028171-34557119-e00c-4678-bb87-048a36ed8585
* Windows 2022 STD(2023.08.22.) KO
    * イメージアップデート
    * 23年7月セキュリティアップデート適用: https://support.microsoft.com/en-us/topic/july-11-2023-security-update-kb5028171-34557119-e00c-4678-bb87-048a36ed8585

### Instance
* インスタンス削除時に、インスタンスに関連付けられているフローティング IP と追加ブロックストレージを同時に削除する機能を追加
...
## 2023. 06. 27.
### System Monitoring
* **[月間指標レポート]** 機能使用時に、断続的に Excel の生成が完了しない問題を修正
* Windows agent
    * 高可用性機能の改善
    * ログ追加
...
### System Monitoring
* バグ修正
    * ダウンロードした月次メトリクスレポートが断続的に正常実行されない問題を修正
...
* ネットワークインターフェイスごとに設定されたセキュリティグループの変更機能を改善
* インスタンス情報 UI を改善
* 削除保護トグルボタンを追加
* 削除保護の一括設定機能を改善
...
## 2022. 07. 26.
### Instance
* インスタンス作成時にインスタンスタイプ（Instance、Ephemeral Storage Instance）を選択する機能を追加しました。
* インスタンス管理でイメージタイプ（OS、Application、DBMSなど）による検索機能を追加しました。

### Image
* Windows イメージの Administrator アカウント名を変更しても、パスワードの初期化が可能になるよう変更しました。

* Windows 2012 R2 STD（2022. 07. 19.）
    * 22年5月セキュリティアップデートを反映: https://support.microsoft.com/en-au/topic/kb5012672-servicing-stack-update-for-windows-8-1-rt-8-1-and-server-2012-r2-april-12-2022-0f0b0460-2483-4d89-868a-56997d1202a5
* Windows 2016 STD（2022. 07. 19.）
    * 22年5月セキュリティアップデートを反映: https://support.microsoft.com/en-us/topic/kb5011570-servicing-stack-update-for-windows-10-version-1607-and-server-2016-march-8-2022-ac6cb59b-d9c1-4b5a-95bc-cf88c9d3e216
* Windows 2019 STD（2022. 07. 19.）
    * 22年5月セキュリティアップデートを反映: https://support.microsoft.com/en-us/topic/april-12-2022-kb5012647-os-build-17763-2803-9a10c5c9-e65f-4ae1-a9c4-2db9a8eca4fc
...
* 一度に作成された複数のインスタンス名からハイフン（`-`）を削除しました。
...
### Image
* インスタンス作成時に Prometheus 互換 exporter が自動的にインストールされないように変更
...
* @Linux、@Windows デフォルトワークスペース追加機能の削除および作成済みワークスペースの削除
    * インスタンス作成時に自動的に追加されていた @Linux、@Windows ワークスペースが自動追加されなくなりました。
    * 既存インスタンスに自動作成されていた @Linux、@Windows ワークスペースがすべて削除されます。

<a id="november-23-2021"></a>

## 2021. 11. 23.
### Image
* GPU インスタンスを作成できる個人イメージの生成をサポート
...
* OpenMetrics ダッシュボード → 照会
    * 照会期間を選択する際、最大1年前の日付まで選択できるように変更
    * データなしまたはエラーに関する案内メッセージがチャートに表示されるように変更
* OpenMetrics ダッシュボード → チャート追加/編集
    * 指標を選択せずに **[追加]** ボタンを押すと案内メッセージが表示され、該当箇所が強調表示されるように変更

<a id="september-14-2021"></a>

## 2021. 09. 14.
### System Monitoring
- 新規 API 追加: ワークスペース、収集対象の照会/追加/削除 API を追加
...
### Instance
* インスタンステンプレートを使用したインスタンス作成をサポート

### Instance Template
* Instance Template サービス追加
    * 頻繁に使用するインスタンス構成要素の情報をテンプレート形式であらかじめ定義して保管
...
* 自動復旧ポリシーのオプション選択項目を追加

### System Monitoring

* バグ修正: 通知グループのサーバー、ユーザーグループを追加する際に「There are no entires.」を選択できた問題を修正
* バグ修正: Advanced Monitoring レイアウトを素早く作成すると5個を超えて作成できた問題を修正
* バグ修正: **Advanced Monitoring → ワークスペース → 収集対象**で、同一ポートに同一名称の別インスタンスを収集対象として追加できなかった問題を修正
...
* Prometheus 호換 exporter
    * Advanced Monitoring サポートのため、インスタンス作成時にこのツールが自動的にインストールされます。
...
* Windows 2012 R2 STD(2021. 06. 22.)
    * 2021年 05月セキュリティアップデートを反映: https://support.microsoft.com/en-us/topic/may-11-2021-kb5003209-monthly-rollup-6be347aa-f8f3-4d26-8260-58d0636f3fe7
* Windows 2016 STD(2021. 06. 22.)
    * 2021年 05月セキュリティアップデートを反映: https://support.microsoft.com/en-us/topic/kb5001402-servicing-stack-update-for-windows-10-version-1607-april-13-2021-0c0367b8-2389-4154-a17e-6df57123423d
* Windows 2019 STD(2021. 06. 22.)
    * 2021年 05月セキュリティアップデートを反映: https://support.microsoft.com/en-us/topic/may-11-2021-kb5003171-os-build-17763-1935-3f03e74b-4759-4ca3-b9f1-4bc0d5ab5d27
...
* OpenMetrics アラートグループの入力ガイド文言を改善
* サーバーダッシュボードのサーバー/エージェント状態ツールチップのサイズを改善
* イベント状況画面で一部のドロップダウンメニューボタンが正常に表示されなかった現象を修正
...
### System Monitoring
* 新機能追加: Advanced Monitoring（OpenMetrics）
    * OpenMetrics（Prometheus exposition format）による指標の収集、照会、アラート機能を提供
...
* Windows 2012 R2 STD(2020. 12. 22.)
    * 2020年11月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4586845/windows-8-1-update
* Windows 2016 STD(2020. 12. 22.)
    * 2020年11月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4586830/windows-10-update-kb4586830
* Windows 2019 STD(2020. 12. 22.)
    * 2020年11月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4586839/windows-10-update-kb4586839
...
### Instance
* **[Windows インスタンス接続情報]** タブに **[パスワードのリセット]** ボタンを追加しました。
* Windows イメージ作成時に元のインスタンスのパスワードをリセットする機能を追加しました。
...
* 意味をより明確に表せるよう、チャートおよび凡例の名称を変更しました。
* サブ項目を持つ収集項目に詳細チャートを表示する機能を追加しました。

### Instance
* キーペアに登録された公開鍵を照会する機能を追加しました。
* GPU インスタンスをコンソールから直接作成できるようサービスを公開しました。
* **[インスタンスの停止]** ダイアログボックスから **[削除]** ボタンを削除しました。
...
## 2020. 02. 25.
### Image
* 個人イメージと共有イメージがイメージ一覧に一緒に表示されるよう変更しました。
* 新規イメージ追加
...
* Windows 2012 R2 STD(2020. 02.18)
    * 2019年12月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4530702/windows-8-1-kb4530702
* Windows 2012 R2 STD with MS-SQL 2012 Standard(2020. 02. 18.)
    * 2019年12月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4530702/windows-8-1-kb4530702
* Windows 2012 R2 STD with MS-SQL 2014 Standard(2020. 02. 18.)
    * 2019年12月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4530702/windows-8-1-kb4530702
...
* Windows 2016 STD(2020. 02. 18.)
    * 2019年12月セキュリティアップデート適用: https://support.microsoft.com/ko-kr/help/4530689/windows-10-update-kb4530689
...
* Agent の改善
    * System Monitoring サーバーとの通信経路を最適化しました。
        * インターネットゲートウェイやセキュリティグループの設定に関係なく、メトリクスを収集できます。
    * CPU およびメモリ使用量の収集精度を改善しました。
...
* 通知グループの **[サーバーおよびユーザーグループ連携]** 機能を改善しました。
    * サーバーおよびユーザーグループを選択し、**[保存]** ボタンを押すと変更内容が保存されるよう変更しました。
...
### Auto Scale
* Auto Scaling 自動復旧
    * Scaling Group に属する個別インスタンスでネットワーク切断などの障害が発生した場合、自動的に新しいインスタンスを作成して障害が発生したインスタンスを置き換える機能を追加しました。
...
* PLOS-WFK-KS-v2.0.60.0.14(2019. 10. 22.)
    * WF-KS ページの Storage サイズ表記の誤りを修正しました。
...
### System Monitoring
* ユーザーインタラクション UI の改善
    * ユーザーグループ、監視グループ、監視設定などのモニタリング情報の照会/追加/修正/削除時にローディングバーが表示されるよう修正しました。
    * インタラクション中の不要なボタンが無効化されるよう修正しました。
* 海外リージョンのバグ修正
    * 日本・米国リージョンで監視設定を変更したサーバーのメトリクス収集が一時的に停止する問題を修正しました。
    * 米国リージョンでユーザーグループおよび監視グループの追加/修正日時が誤って表示される問題を修正しました。

### VPC
* Default VPC 削除機能を追加しました。
    * Default VPC をユーザーが削除できるよう修正しました。
...
* Internet Explorer 11 ブラウザ環境でサーバーダッシュボードのレイアウト選択に失敗する問題を修正しました。
...
* Windows 2012 R2 STD(2019. 08. 27.)
    * 2019年7月10日セキュリティアップデート適用: https://support.microsoft.com/en-gb/help/4507448/windows-8-1-update-kb4507448
...
* Windows 2016 STD(2019. 08. 27.)
    * 2019年7月10日セキュリティアップデート適用: https://support.microsoft.com/en-us/help/4507460/windows-10-update-kb4507460
...
* System Monitoring サービスを追加しました。
    * 作成された仮想サーバーのシステムメトリクスチャートを提供します。
    * 各システムメトリクスチャートを任意のレイアウトで構成できます。
    * メトリクスが特定のしきい値に達した場合、指定したユーザーグループに通知を送信するよう設定できます。
...
* Windows 2012 R2 STD(2019. 05. 28.)
    * リージョンに応じたタイムゾーン変更を適用しました。
    * 2019年5月14日セキュリティアップデート: https://support.microsoft.com/ko-kr/help/4499151/windows-8-1-update-kb4499151
...
* Windows 2016 STD(2019. 05. 28.)
    * リージョンに応じたタイムゾーン変更を適用しました。
    * 2019年5月14日セキュリティアップデート: https://support.microsoft.com/ko-kr/help/4498947/windows-10-update-kb4498947
...
* Ubuntu Server 18.04.2 LTS(2019. 02. 26.)
    ...
    * ネットワークインターフェイスまたは Subnet の追加・削除時に間欠的に発生する通信エラーを修正しました。
...
* Image 照会 API にページネーション用クエリパラメータを追加しました。
...
* Ubuntu Server 14.04.5 LTS(2018. 12. 27.)
    * shell 上でオートコンプリート (tab) 機能使用時に LC_CTYPE 関連の warning message が発生する現象を修正しました。
...
* CentOS 7.5(2018. 10. 23.)、CentOS 7.1(2018. 10. 23.)、CentOS 6.10(2018. 10. 23.)、CentOS 6.5(2018. 10. 23.)
    ...
    * ssh 設定の変更(/etc/ssh/sshd_config を修正)
        * PermitRootLogin no                # root 接続を無効化
        * PasswordAuthentication no         # パスワード認証を無効化
    * 脆弱性対策のためのカーネルパラメータ変更(/etc/sysctl.conf を修正)
...
* Ubuntu Server 18.04.1 LTS(2018. 09. 20.)
    ...
    * ターミナルから 120 分以上ユーザー入力がない場合にセッションを終了(/etc/profile を修正)
        * TMOUT=7200
    * インスタンス作成時に swap partition を作成しません(必要な場合はユーザーが別途作成してください)
...
* Windows 2012 R2 STD(2018. 08. 09.)
    * 日本語使用時はユーザーが日本語言語パックをインストール（デフォルトは英語版を提供）
    ...
    * サービス管理
        * NTP設定: 1.pool.ntp.org, time,windows.com
        * NTP同期周期: 256秒
    * システム管理
        * Network access: Do not allow anonymous enumeration of SAM accounts : Enabled
        * Network access: Do not allow anonymous enumeration of SAM accounts and shares : Enabled
        * Autologin機能制限: AutoAdminLogon の値を 0 に設定
...
* Debian 9.4.0(2018. 08. 09.)
    ...
    * 不要なアカウント/グループの削除
        ...
        * group: dip
    * 脆弱性対策のカーネルパラメーター変更(sysctl)
        * net.ipv4.conf.all.accept_redirects = 0 # ICMP リダイレクト攻撃の遮断
        * net.ipv4\.conf.all.accept_source_route = 0 # ソースルーティング遮断による IP スプーフィング防止
        * net.ipv4.conf.all.log_martians = 1 # スプーフィングのログ記録
        * net.ipv4.icmp_echo_ignore_broadcasts = 1 # Smurf DoS 攻撃の防御
        * net.ipv4.icmp_ignore_bogus_error_responses = 1 # IP または TCP ヘッダーが破損した不正な ICMP パケットを無視
        * net.ipv4.tcp_syncookies=1 # SYN フラッド攻撃防御のための SYN Cookie を使用
    * SSH設定変更
        * PermitRootLogin 無効化
    ...
    * profile の追加(/etc/profile)
        ...
        * HISTSIZE=500       # history リストに保存するコマンド数の制限
        * HISTFILESIZE=0     # history ファイルに保存するコマンドなし
    * システムログイン前バナー設定の削除
...
* Windows 2012 R2 STD(2018. 07. 16.)
    * Auto Scale 機能でウイルス対策ソフトを含むインスタンスを作成する際に発生するエラーを修正
    * CPU 設定を変更(CPU ソケットの最大数を 4 個に設定)
    * ネットワークインターフェースの速度が 10G と表示されるよう修正

* Windows 2008 R2 STD(2018. 07. 16.)
    * 2018年6月12日付けセキュリティアップデート: https://support.microsoft.com/ko-kr/help/4284826
    * アカウント管理
        * Guest アカウントの使用制限: Guest アカウントを無効に変更
        * 最終ユーザーのログイン名の表示: 表示しないに設定
        * セッションがロックされた場合のユーザー情報表示: ユーザー名のみ表示に設定
...
* Ubuntu 16.04.4 LTS(2018. 07. 16.)
    ...
    * パスワード複雑度の設定(数字・英字・記号の組み合わせ + 8 文字以上): /etc/pam.d/common-password に以下の行を追加
        * password requisite  pam_cracklib.so try_first_pass retry=3 minlen=8 lcredit=-1 dcredit=-1 ocredit=-1 type=
    * 不要なアカウント/グループの削除
        * user: lp, sync, uucp, games
        * group: dip
    * 脆弱性対策のカーネルパラメータ変更(sysctl)
        ...
        * net.ipv4.icmp_ignore_bogus_error_responses = 1 # IP または TCP ヘッダーが破損した不正な ICMP パケットを無視
        * net.ipv4.tcp_syncookies=1 # SYN フラッディング攻撃対策のための SYN cookies を使用
    * SSH 設定変更
...
## 2018. 05. 29.
### Auto Scale
* 繰り返しスケジュールタスク(cron expression ベース)に関連するエラーを修正
    * 繰り返しスケジュールタスクの実行タイミングが UTC を基準に動作するエラーを修正
    * 繰り返しスケジュールタスクの初回実行が cron expression に従わず、スケジュールタスク作成時に設定した「開始時刻」に実行されるエラーを修正
...
* Auto Scale サービスを追加
    ...
    * Scaling Group に属するインスタンスの数をインスタンスの状態またはスケジュールタスクを通じて動的に管理
...
* Windows 2012 R2 STD(2018. 02. 22.)
    ...
    * 2018年2月13日付けセキュリティアップデート: https://support.microsoft.com/ko-kr/help/4074594/windows-81-update-kb-4074594
...
* 新規イメージ追加
    * CentOS Linux 6.5 with MySQL 5.6.38(2018. 02. 22.)
        ...
        * その他の設定は CentOS Linux 6.5 イメージと同一
...
* TOAST Compute サービスに対する API を提供
    ...
    * サポートされる API についてはガイドドキュメントを参照してください
...
* インスタンスのスペック変更機能を追加
    ...
    * 詳細な制約事項についてはガイドドキュメントの [インスタンスのスペック変更](/Compute/Instance/ja/console-guide/#modify-flavor) を参照してください
* Low IOPS SSD スペック(U タイプ)を追加
    * リーズナブルな価格の低スペックインスタンスをサポート
    * Linux 系 OS のみサポート
    * ローカルディスクを使用するため、ハードウェア障害時にデータの復旧が不可能
* High IOPS SSD スペック(I タイプ)を追加
    * 高 IOPS を保証(保証 IOPS は価格表を参照)
    * Linux 系 OS のみサポート
* インスタンス使用量の照会時に値が取得されないバグを修正

<a id="may-25-2017"></a>

## 2017. 05. 25.
### Instance
* サービス終了済みイメージから作成されたインスタンスが表示されないバグを修正
...
* インスタンス作成時に初期ボリュームのサイズを指定する機能を追加
    ...
    * 基本ディスクのサイズはイメージごとの最小要件から最大 600GB まで設定可能

<a id="january-19-2017"></a>

## 2017. 01. 19.
### Instance
* インスタンスの基本情報の IP アドレス情報からサブネット名称を除外
    * 名称の表記により行の幅が広がり可読性が低下するのを防止
* インスタンス名の長さおよび特殊文字の制限
    * インスタンス名は 20 文字以下の英数字と **.**（ドット）、**-**（ダッシュ）のみ許可
* インスタンス作成機能をイメージ作成機能に変更
    * タブと一貫した機能に変更

### Image
* イメージタブ(Private、Shared、Public)の切り替え時にイメージの選択が解除されない問題を修正
...
* インスタンス作成時に選択可能なセキュリティグループが 1 つの場合、自動選択されるよう変更