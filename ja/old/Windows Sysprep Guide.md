<!-- pre-align:aligned sig=cadf51061872 -->

<a id="infrastructure-compute-network-windows-sysprep-guide"></a>
## Infrastructure > Compute & Network > Windows Sysprep Guide { #infrastructure-compute-network-windows-sysprep-guide }
...
<a id="sysprep-system-preparation"></a>
## Sysprep (System Preparation) { #sysprep-system-preparation }
...
<a id="sysprep-shutdown"></a>
#### shutdown
Windows를 종료합니다.

<a id="sysprep-unattend"></a>
#### unattend
