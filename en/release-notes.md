...
## May 27, 2026
### Instance
* Adjusted the default value of the `limit` parameter for the List Instances API to 100 and the maximum value to 1,000
* Added information on whether the cumulative suspension period of an instance has exceeded 90 days

### Image
* Adjusted the default value of the `limit` parameter for the List Images API to 100 and the maximum value to 1,000
...
## March 10, 2026
### Image
* Disabled GRUB BLS configuration for Rocky 9.7 image
* Removed bullseye-backports repository for Debian 11.11 from sources.list due to end of support
...
* Improved image modification feature
    * Added option to configure whether the image download feature is enabled
...
* Added a feature to set the block storage deletion policy when creating an instance or attaching block storage
* Revised the policy for deleting associated resources when deleting an instance from the console
    * Snapshots that exist at the time of block storage deletion are now deleted together
...
## March 4, 2025
### Instance
* Added a feature to change instance descriptions
* Restricted changing the API password to the same password as the current one
...
* GPU and container-related (Linux)
    ...
    * Fixed an issue where DCGM-Exporter was not installed (NVIDIA, Deep Learning images)
...
### Instance
* Added a feature to change the instance key pair
...
## May 28, 2024
### Instance
* Expanded search/filter conditions and improved the UI in the instance list
...
## April 23, 2024
### Instance
* End of instance type support - applicable to Korea (Pangyo) region
...
### Instance
* Added a feature to create an image from an instance with an encrypted root block storage
...
## November 28, 2023
### Instance
* Added instance termination feature

### Public API
* Added APIs for terminating instances and starting terminated instances
...
* GPU and container related (Linux)
	* debian 11 container - Added GPU driver / cluster creation available after selecting GPU flavor
	* NVIDIA driver update: 470.199.02 → 535.104.12
	* CUDA update: 11.4 → 12.2
	* MIG Manager: 0.5.4 → 0.5.5

* GPU (Windows)
	* NVIDIA driver update: 474.44 → 537.13

* Security update (Linux)
	* CentOS 7.9: Removed SetUID from /usr/bin/newgrp, /sbin/unix_chkpwd
...
* PIOLINK WEBFRONT-KS 4.0.6.61.28(2023.04.25.)
	* Image name changed: PLOS-WAF-KS-v4.0.6.61.28(2023.04.25.) → PIOLINK WEBFRONT-KS 4.0.6.61.28(2023.04.25.)
...
### Instance Template
* Added support for encrypted block storage type
...
### Instance
* Improved **CloudTrail** logs for instance creation and instance deletion
* Improved the UI to allow multiple existing network interfaces to be specified when creating an instance
...
### System Monitoring
* Bug Fixes
    * Fixed an issue where downloaded monthly metric reports intermittently failed to open correctly
...
### Image Builder
* Added Features
    * Personal images can now be selected as the base image when building an image

### Public API
* Changed API endpoint

### System Monitoring
* Removed the `1 minute` option from the period selection criteria in monthly metric reports
...
### Instance
* Improved the UI to allow configuration changes when creating an instance from an **Instance Template**
...
* Improved the UI to allow configuration changes when creating a scaling group from an **Instance Template**
...
## November 29, 2022
### Instance
* Added deletion protection (All/Set/Not Set) to the **filter conditions** in instance management
...
* Windows 2012 R2 STD (November 22, 2022)
    * End of support for Japanese images
...
## July 26, 2022
### Instance
* Added the ability to select an instance type (Instance, Ephemeral Storage Instance) when creating an instance
* Added the ability to search by image type (OS, Application, DBMS, etc.) in instance management

### Image
* Changed the password reset to work even when the Windows image Administrator account name is changed
...
### System Monitoring
* Added new feature: Monthly Metrics Report
  * You can generate and download a monthly metrics report.
  * You can generate a report covering up to 6 months of metrics data, in monthly increments.
  * The `GENERAL` option in the metric selection refers to metrics available on the `Server Dashboard`, and `PROMQL` refers to metrics available on the `OpenMetrics Dashboard`.
  * You can check each request in the `Monthly Metrics Report`, and the report is available for download for one month after it is generated.

<a id="may-24-2022"></a>

## May 24, 2022
### Instance
* Added an instance screenshot feature
* Added an instance deletion protection feature
* Changed the API response to include the instance deletion protection attribute (`NHN-EXT-ATTR:protect`) when retrieving instances
* Removed the hyphen (`-`) from the names of multiple instances created at once
...
### Image
* Added the ability to replicate images to another region
...
### System Monitoring
* Removed the @Linux and @Windows default workspace addition feature, and deleted existing workspaces
    ...
    * All @Linux and @Windows workspaces that were automatically created on existing instances will be deleted.
...
## September 14, 2021
### System Monitoring
- Added new APIs: APIs for viewing, adding, and deleting workspaces and collection targets
- Added @Linux and @Windows default workspaces
    - @Linux: Collects metrics from the node exporter installed on the instance. When a Linux OS instance is created, it is automatically registered as a collection target of @Linux.
    - @Windows: Collects metrics from the windows exporter installed on the instance. When a Windows OS instance is created, it is automatically registered as a collection target of @Windows.
...
### Instance Template
* Added Instance Template service
    * Predefine and store frequently used instance component information in template form
...
* Bug fix: Fixed an issue where more than 5 Advanced Monitoring layouts could be created when created in rapid succession
* Bug fix: Fixed an issue where a different instance with the same name on the same port could not be added as a collection target under **Advanced Monitoring → Workspace → Collection Target**
...
* Fixed an issue where instance name changes made in **Compute → Instance** were not reflected in the server list on the server dashboard
...
* Added new feature: Advanced Monitoring (OpenMetrics)
    * Provides OpenMetrics (Prometheus exposition format) metric collection, query, and alert features
...
* Added a feature to reset the original instance password when creating a Windows image

### Image
* Added new images:
    * CentOS 7.8 (August 18, 2020)
...
* Updated chart and legend names for improved clarity
* Added a detailed chart display feature for collected metrics that have sub-items

### Instance
* Added a feature to view the public key registered to a key pair
...
* Improved the Event Status page:
    ...
    * Added a **Force Stop** button that allows users to manually close events
* Improved the agent:
...
* Improved the **Server and User Group Integration** feature in notification groups:
    * Changed so that changes are saved only after selecting a server and user group and clicking the **Save** button

<a id="december-17-2019"></a>

## December 17, 2019
### Auto Scale
* Updated the instance template list and detail views to display all information entered at the time of creation:
    * List table: availability zone
    * Detail view: all configured network information and user script content

<a id="november-26-2019"></a>

## November 26, 2019
### Auto Scale
* Added Auto Scaling auto-recovery:
    * Added a feature that automatically creates a new instance to replace a failed instance when a failure such as a network disconnection occurs on an individual instance in a scaling group
...
* PLOS-WFK-KS-v2.0.60.0.14 (October 22, 2019)
    * Fixed a storage size display error on the WF-KS page

* Windows 2012 R2 STD (October 22, 2019)
    * Images provided by language (KO, EN, JP)
...
### System Monitoring
* Improved user interaction UI:
    * Updated loading bar to appear when viewing, adding, modifying, or deleting monitoring information such as user groups, monitoring groups, and monitoring settings
    * Updated unnecessary buttons to be disabled during interactions
* Fixed bugs in overseas regions:
    * Fixed an issue where metric collection was temporarily stopped for servers whose monitoring settings were changed in the Japan and US regions
    * Fixed an issue where the creation and modification dates of user groups and monitoring groups were displayed incorrectly in the US region
...
* Fixed an issue where selecting a layout on the server dashboard failed in Internet Explorer 11
...
* Improved UI for Internet Explorer 11
...
* Added the System Monitoring service:
    ...
    * Allows you to configure notifications to be sent to a specific user group when a metric reaches a defined threshold

<a id="june-25-2019"></a>

## June 25, 2019
### Instance
* Updated to allow image creation while an instance is running

<a id="may-28-2019"></a>

## May 28, 2019
### Auto Scale
* Added a statistics graph to monitor the usage of Scaling Groups
...
## April 25, 2019
### Auto Scale
* Added timezone configuration support when creating scheduled tasks
...
## January 29, 2019
### Public API
* Updated instance creation to support subnet specification
* Added query parameters for pagination to the Image List API
...
* Ubuntu Server 14.04.5 LTS(December 27, 2018)
    * Fixed an issue where an LC_CTYPE-related warning message appeared when using the tab auto-complete feature in the shell
...
* CentOS 7.5 (2018. 10. 23.), CentOS 7.1 (2018. 10. 23.), CentOS 6.10 (2018. 10. 23.), CentOS 6.5 (2018. 10. 23.)
    * Password complexity settings: combination of numbers, English characters, and special characters + at least 8 characters (/etc/pam.d/common-password modified)
    ...
    * Session termination after 120 minutes of no user input from terminal (/etc/profile modified)
        * TMOUT=7200
    ...
    * No swap partition is created when creating an instance
...
## September 20, 2018
### Instance
* Improved UX/UI for the instance management screen
    * Added instance name search
    * Added availability zone and instance status filters
* Improved features and UX/UI for the instance creation screen
    * Added an option to select whether to use a floating IP
    * Added security group creation and policy review features
    * Added the ability to attach additional block storage
    * Added user script registration

### Image
* Fixed an issue where the user script feature was not applied correctly

* Ubuntu Server 18.04.1 LTS (2018. 09. 20.)
    * Kernel 4.15.0-29: Meltdown/Spectre variant 1, 2, 3 (CVE-2017-5753, 5715, 5754) patches (retpoline)
    * Password complexity settings: combination of numbers, English characters, and special characters + at least 8 characters (/etc/pam.d/common-password modified)
        * password requisite  pam_cracklib.so try_first_pass retry=3 minlen=8 lcredit=-1 dcredit=-1 ocredit=-1 type=
    * SSH configuration changes (/etc/ssh/sshd_config modified)
        * PermitRootLogin no                # Disable root login
    ...
    * Session termination after 120 minutes of no user input from terminal (/etc/profile modified)
        * TMOUT=7200
    * No swap partition is created when creating an instance (create one manually if needed)
...
* Windows 2012 R2 STD (August 9, 2018)
    * Users who need to use Korean must install the Korean language pack (English version provided by default)
    * Security update for July 10, 2018: https://support.microsoft.com/en-us/help/4338815/windows-81-update-kb4338815
    * Account management
...
* Windows 2016 STD (August 9, 2018)
    * Security update for July 24, 2018: https://support.microsoft.com/en-us/help/4338822/windows-10-update-kb4338822
    * Account management
        * Interactive logon: Display user information when the session is locked : User display name only
        * Interactive logon: Do not display last user name :  Enabled
        * Interactive logon: Prompt user to change password before expiration : 14days
...
* Debian 9.4.0 (August 9, 2018)
    ...
    * Password complexity settings (combination of numbers, letters, and special characters, 8 or more characters): Add the following line to /etc/pam.d/common-password
        * password requisite  pam_cracklib.so try_first_pass retry=3 minlen=8 lcredit=-1 dcredit=-1 ocredit=-1 type=
    * Remove unnecessary accounts/groups
        * user: lp, sync, uucp, games
        * group: dip
    * Kernel parameter changes to guard against vulnerabilities (sysctl)
        * net.ipv4.conf.all.accept_redirects = 0 # Block ICMP redirect attacks
        * net.ipv4\.conf.all.accept_source_route = 0 # Prevent IP spoofing by blocking source routing
        * net.ipv4.conf.all.log_martians = 1 # Log spoofing attempts
        * net.ipv4.icmp_echo_ignore_broadcasts = 1 # Defend against smurf DoS attacks
    ...
    * Permission settings
        ...
        * /etc/gshadow 400
        * /etc/login.defs 400
    * Terminal access restriction: Modify /etc/securetty
    * Add profile settings (/etc/profile)
    ...
    * Remove pre-login system banner settings
...
* Windows 2012 R2 STD (July 16, 2018)
    * Fixed an error that occurred when creating an instance that includes antivirus software using the Auto Scale feature
    * Changed CPU settings (maximum number of CPU sockets: 4)
...
* Windows 2008 R2 STD (July 16, 2018)
    ...
    * Account management
        * Restricted Guest account usage: changed to disable the Guest account
        ...
        * Notify before password expiration: set notification to 14 days before expiration
        * Restricted system shutdown by general users: set system shutdown policy to Administrator only
    * Service management
        * NTP settings: 1.pool.ntp.org, time.windows.com
        * NTP synchronization interval: 256 seconds
    * System management
        * Do not allow anonymous enumeration of SAM accounts and shares: enabled the setting to disallow anonymous enumeration of SAM accounts
        * Restrict allowing system shutdown without logon: set the policy to allow system shutdown without logon to disabled
        * Restricted Autologin: set the AutoAdminLogon value to 0

* Ubuntu 16.04.4 LTS (July 16, 2018)
    * Kernel 4.4.0-130: applied patches for meltdown/spectre variants 1, 2, and 3 (CVE-2017-5753, 5715, 5754) (retpoline)
    * Password complexity settings (combination of numbers, letters, and special characters + at least 8 characters): added the following line to /etc/pam.d/common-password
        * password requisite  pam_cracklib.so try_first_pass retry=3 minlen=8 lcredit=-1 dcredit=-1 ocredit=-1 type=
    * Removed unnecessary accounts/groups
        * user: lp, sync, uucp, games
        * group: dip
    * Changed kernel parameters to address vulnerabilities (sysctl)
        * net.ipv4.conf.all.accept_redirects = 0 # Block ICMP redirect attacks
        * net.ipv4\.conf.all.accept_source_route = 0 # Prevent IP spoofing by blocking source routing
        * net.ipv4.conf.all.log_martians = 1 # Log spoofing attempts
        * net.ipv4.icmp_echo_ignore_broadcasts = 1 # Defend against Smurf DoS attacks
    ...
    * SSH settings changed
        ...
        * Applied immutable attribute to /etc/ssh/sshd_config
    ...
    * Added profile settings (/etc/profile)
        ...
        * HISTSIZE=500       # Limit the number of commands stored in the history list
        * HISTFILESIZE=0     # No commands saved to the history file
    * Removed system pre-login banner settings
...
* Fixed errors related to recurring scheduled tasks (cron expression-based)
    * Fixed an issue where recurring scheduled tasks ran based on UTC time
    * Fixed an issue where the first execution of a recurring scheduled task did not follow the cron expression and instead ran at the start time set when the scheduled task was created
...
### April 24, 2018
### Instance
* Removed the feature to view logs for Windows instances
...
## February 22, 2018
### Instance
* Changed instance creation to require subnet specification following the addition of the VPC feature

### Image
* Windows 2012 R2 STD (February 22, 2018)
    * Changed Windows Time Zone settings
        * Changed synchronization interval: [Before] 604,800 seconds (7 days) → [After] 256 seconds
...
* Ubuntu Linux 14.04.5 (February 22, 2018)
    * Updated kernel to patch vulnerabilities
...
* Debian Linux 8.2.0 (February 22, 2018)
    * Fixed an issue where the hostname was not set to the name specified when creating an instance
    * Updated kernel to patch vulnerabilities
...
## September 21, 2017
### Public API
* Added API support for the TOAST Compute service
...
## July 20, 2017
### Image
* Fixed a bug where the creation of large images intermittently failed to complete
...
* Added the instance flavor change feature
    * You can upgrade or downgrade CPU/memory while keeping the disk of the existing instance intact
    * Block storage size cannot be changed
    * The instance must be in a stopped state to change its flavor
    * For more information on constraints, see [Modify Instance Flavor](/Compute/Instance/en/console-guide/#modify-flavor) in the guide documentation
...
* Added the High IOPS SSD flavor (I type)
    ...
    * Supports Linux-based OS only
* Fixed a bug where instance usage data was not retrieved when querying instance usage
...
* Added the ability to specify the initial volume size when creating an instance
    * Creates the initial volume with the size specified by the user
...
## January 19, 2017
### Instance
* Removed subnet names from the IP address information in the instance's basic information
    * Prevents reduced readability caused by wider rows due to name display
* Restricted instance name length and special characters
    * Instance names are limited to 20 characters or fewer and allow only alphanumeric characters, **.**  (dot), and **-** (dash)
* Changed the instance creation feature to an image creation feature
