...
* 인스턴스 사양 변경 기능 추가
    ...
    * 자세한 제약 사항은 가이드 문서 [인스턴스 사양 변경](/Compute/Instance/ko/console-guide-gov/#modify-flavor) 참조
