...
| 타입          | 리전 | 엔드포인트                                               |
|-------------|---|---------------------------------------------------------|
| identity    | 모든 리전 | https://api-identity-infrastructure.ngoic.go.kr          |
| compute     | 한국(판교) 리전 | https://kr1-api-instance-infrastructure.ngoic.go.kr      |
| network     | 한국(판교) 리전 | https://kr1-api-network-infrastructure.ngoic.go.kr       |
| image       | 한국(판교) 리전 | https://kr1-api-image-infrastructure.ngoic.go.kr         |
| volumev2    | 한국(판교) 리전 | https://kr1-api-block-storage-infrastructure.ngoic.go.kr |
